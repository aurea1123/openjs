...
var merkleHashSummary = require('../../../src/base/merkle/proof/merkleproof').merkleHashSummary
var TreeHelper = require('../../base/merkle/treehelper').TreeHelper
...
describe("dict to merkle root test", () => {
  it("test dict of 1 root", () => {
    ...
    assert.deepEqual(expecedMerkleRoot_dict1_array4, helper.convertToHex(merkleProofRoot.merkleHash))
  })
})
